...
import me.proton.core.drive.observability.domain.metrics.sdk.DownloadSuccessRateTotal.Companion.SCHEMA_ID
import me.proton.core.observability.domain.entity.SchemaId

@Serializable
@Schema(description = "Count of unique successful or failed downloads")
@SchemaId(SCHEMA_ID)
data class DownloadSuccessRateTotal(
    ...
    companion object {
        const val SCHEMA_ID = "https://proton.me/drive_sdk_download_success_rate_total_v1.schema.json"
    }
}
