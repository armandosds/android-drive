...
import me.proton.core.drive.observability.domain.metrics.sdk.UploadErroringUsersTotal.Companion.SCHEMA_ID
import me.proton.core.observability.domain.entity.SchemaId

@Serializable
@Schema(description = "How many users experienced upload error in the past 5 minutes")
@SchemaId(SCHEMA_ID)
data class UploadErroringUsersTotal(
    ...
    companion object {
        const val SCHEMA_ID = "https://proton.me/drive_sdk_upload_erroring_users_total_v1.schema.json"
    }
}
