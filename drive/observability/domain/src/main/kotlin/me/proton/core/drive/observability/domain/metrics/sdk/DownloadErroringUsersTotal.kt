...
import me.proton.core.drive.observability.domain.metrics.sdk.DownloadErroringUsersTotal.Companion.SCHEMA_ID
...
data class DownloadErroringUsersTotal(
    ...
    companion object {
        const val SCHEMA_ID = "https://proton.me/drive_sdk_download_erroring_users_total_v1.schema.json"
    }
}
