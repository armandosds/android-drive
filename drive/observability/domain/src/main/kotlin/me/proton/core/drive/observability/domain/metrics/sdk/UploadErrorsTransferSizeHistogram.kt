...
import me.proton.core.drive.observability.domain.metrics.sdk.UploadErrorsTransferSizeHistogram.Companion.SCHEMA_ID
...
data class UploadErrorsTransferSizeHistogram(
    ...
    companion object {
        const val SCHEMA_ID = "https://proton.me/drive_sdk_upload_errors_transfer_size_histogram_v1.schema.json"
    }
}
