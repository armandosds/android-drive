...
class HasSignatureVerificationFailed @Inject constructor(
    private val linkDownloadRepository: LinkDownloadRepository,
) {

    suspend operator fun invoke(fileId: FileId): Result<Boolean> = coRunCatching {
        linkDownloadRepository.hasSignatureVerificationFailed(fileId)
    }
}
