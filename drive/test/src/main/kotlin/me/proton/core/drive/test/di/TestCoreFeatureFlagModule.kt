...
import me.proton.core.featureflag.dagger.CoreFeatureFlagBindsModule
...
object TestCoreFeatureFlagModule {
    ...
    public fun provideFeatureDisabledListener(
        ...
        monoClock = { System.currentTimeMillis() }
    )
}
...
@TestInstallIn(
    components = [SingletonComponent::class],
    replaces = [CoreFeatureFlagBindsModule::class]
)
interface TestCoreFeatureFlagBindModule {
